...
:alt: Navigo flow-matching training panel from the paper
:width: 100%
:align: center

Population-level flow matching from Figure 1f of the Navigo paper. Training alternates between pseudo-pair refinement and vector-field learning.
```
...
Training then alternates between fitting the field under the current pseudo-pairs and updating the pseudo-pairs using the new predictions. This iterative refinement is the reflow procedure described in the paper.
